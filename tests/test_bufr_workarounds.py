...
import eccodes; from eccodes import *
...
@pt.mark.skipif(eccodes.__version__ < '2.41.0',
...
def test_workaround_for_ECC_1624():
    ...
    bufr['unexpandedDescriptors'] = [307011, 7006, 10004, 222000, 101023, 31031, 1031, 1032, 101023, 33007]
...
def test_workaround_for_ECC_2098():
    ...
    bufr['windDirection->associatedField->associatedFieldSignificance'] = [1, 1, 1] # Would raise ArrayTooSmallError when packing
    bufr.pack()
